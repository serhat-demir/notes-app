...
public class NotesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        viewModel.toastObserverNotes.observe(getViewLifecycleOwner(), value -> Toast.makeText(requireContext(), value, Toast.LENGTH_SHORT).show());

        viewModel.notes.observe(getViewLifecycleOwner(), notes -> {
            binding.setNoteAdapter(new NoteAdapter(requireContext(), notes, viewModel));
